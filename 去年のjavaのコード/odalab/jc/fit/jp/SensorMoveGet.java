...
public class SensorMoveGet implements Runnable {
	public static int defaultPort = 8181;
	InetAddress inet;
	int portNumber = defaultPort;
	DatagramSocket socket;
	double timing = 0.1;
	String defaultCommand = "move accel";
	...
	public SensorMoveGet(InetAddress i,NetSensorListener s) throws IOException {
		inet = i;
		par = s;
		setup();
	}

	public SensorMoveGet(InetAddress i,NetSensorListener s,String command) throws IOException {
		inet = i;
		par = s;
